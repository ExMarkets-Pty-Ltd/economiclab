(function () {
  ...
  function marketFallback() { all('[data-nfp-symbol]').forEach(function (card) { card.querySelector('strong').textContent = 'Data unavailable'; card.querySelector('small').textContent = 'Existing EconomicLab quote provider unavailable'; }); }
